...
$check=false;
$error =false;
$insert= "INSERT INTO `Material` VALUES ('$id','$amount','$name','$price')";
...
if(isset($_POST['ID'])&& $_POST['name']&&$_POST['Amount']&&$_POST['Price'])
{
   if($con->query($insert))
   {
       $check=true;
...
<style id="applicationStylesheet" type="text/css">
	.mediaViewInfo {
		--web-view-name: Add material;
		--web-view-id: Add_material;
		--web-scale-on-resize: true;
		--web-enable-deep-linking: true;
	}
	:root {
		--web-view-ids: Add_material;
	}
	* {
		margin: 0;
		padding: 0;
	...
	#Group_57 {
		...
		--web-animation: ;
		--web-action-type: page;
		--web-action-target: popup_add_material.html;
	}
	.Rectangle_4 {
		position: absolute;
		overflow: visible;
...
<body>
<div id="Add_material" onclick="application.goBack()">
	<div id="Group_10">
